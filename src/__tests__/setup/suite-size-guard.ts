...
/** IDEIGLENES, meressel felulirando -- merve 2026. 09. 04. 11:45:02 CEST -- `npx vitest list --json` -> 411 fajl / 5225 teszt. */
export const SUITE_BASELINE_FILES = 411
export const SUITE_BASELINE_TESTS = 5225
// === SUITE-BASELINE:END ===
