...
/** Merve 2026-08-27 12:2x CEST, a BEOLVASZTOTT fan -- `npx vitest list --json` -> 336 fajl / 4512 teszt. */
export const SUITE_BASELINE_FILES = 336
export const SUITE_BASELINE_TESTS = 4512
// === SUITE-BASELINE:END ===
